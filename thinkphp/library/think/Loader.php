...
class Loader
{
    ...
    public static function register($autoload = '')
    {
        ...
        self::addAutoLoadDir($rootPath.'zxw');
    }
    ...
    private static function findFile($class)
    {
        ...
        // 查找 PSR-4
        $logicalPathPsr4 = strtr($class, '\\', DIRECTORY_SEPARATOR) . '.php';  //think\Error.php
        $first = $class[0];
        if (isset(self::$prefixLengthsPsr4[$first])) {
            //$prefix = 'think\composer' \ 'think' \ 'traits'
     ...
     * @return mixed
     */
    public static function factory($name, $namespace = '', ...$args)  //php ， ，config/app.php
    {
